 ...
 *                             One of actor, owner, container, or type/subtype is required
 *
 ...
 * @since 1.9
 */
function elgg_subscribe($user, $data_class, array $params, array $methods) {
	...
	// @todo validate all keys in params
 ...
 * @since 1.9
 */
function elgg_unsubscribe($user, $data_class, array $params, array $methods) {
